        ...
        <div className="navbar navbar-container">
            <div className="navbar-content px-2">
                <div className="left-icons">
                    <span className="d-inline-block" tabIndex="0" data-toggle="tooltip" title="Instrucciones del juego">
                        <button onClick={() => isModalShow()} type="button" className="button-icon">
